...
# UPDATE EACH MONTH
# create date values
# filterDte <- '2023-03-31'
# reptDte <- 'March 31, 2023'
```
...
```{r ,  out.width='100%' , out.height='100%' , label = 'PandLYTD'}
...
ftCurr
# htmltools::includeHTML(sprintf(here('PVHC P & L for %s.html' , format(as.Date(fy_to_date) , format = '%b %Y'))))
```
...
```{r}
# image_read("OwnersDrawDetail.png") %>% 
#   image_trim()
htmltools::includeHTML('OwnersDrawDetail.html')
```
